OC.L10N.register(
    ...
    "Failed to load organization libraries." : "Failed to load organization libraries.",
    "Uploaded library \"{name}\"." : "Uploaded library \"{name}\".",
    "Organization library uploaded." : "Organization library uploaded.",
    "Failed to upload organization library." : "Failed to upload organization library.",
    "Delete organization library \"{name}\"? It will no longer appear in users' library panels." : "Delete organization library \"{name}\"? It will no longer appear in users' library panels.",
    "Organization library deleted." : "Organization library deleted.",
    "Failed to delete organization library." : "Failed to delete organization library.",
    "Failed to load organization canvases." : "Failed to load organization canvases.",
    "Uploaded canvas \"{name}\"." : "Uploaded canvas \"{name}\".",
    "Organization canvas uploaded." : "Organization canvas uploaded.",
    "Failed to upload organization canvas." : "Failed to upload organization canvas.",
    "Delete organization canvas \"{name}\"? It will no longer appear in the \"New whiteboard\" picker. Boards already created from it keep their content." : "Delete organization canvas \"{name}\"? It will no longer appear in the \"New whiteboard\" picker. Boards already created from it keep their content.",
    "Organization canvas deleted." : "Organization canvas deleted.",
    "Failed to delete organization canvas." : "Failed to delete organization canvas.",
    "_%n library item_::_%n library items_" : ["%n library item","%n library items"],
    ...
    "Templates shared with everyone in this organization." : "Templates shared with everyone in this organization.",
    "Organization templates require Nextcloud 30 or later. Upgrade to make them available in the \"New whiteboard\" picker." : "Organization templates require Nextcloud 30 or later. Upgrade to make them available in the \"New whiteboard\" picker.",
    "Libraries" : "Libraries",
    "Shape libraries shown to everyone as read-only sections in the whiteboard library panel. Upload an .excalidrawlib file; its shapes appear in every user’s library alongside their own." : "Shape libraries shown to everyone as read-only sections in the whiteboard library panel. Upload an .excalidrawlib file; its shapes appear in every user’s library alongside their own.",
    "Uploading…" : "Uploading…",
    "Upload library" : "Upload library",
    "Loading organization libraries…" : "Loading organization libraries…",
    "No organization libraries yet. Upload an .excalidrawlib file to share a set of shapes with everyone." : "No organization libraries yet. Upload an .excalidrawlib file to share a set of shapes with everyone.",
    "Delete library {name}" : "Delete library {name}",
    "Delete" : "Delete",
    "Canvases" : "Canvases",
    "Whiteboard canvases available to everyone in the \"New whiteboard\" picker. Upload a .whiteboard file; new boards created from it start with a copy of its content." : "Whiteboard canvases available to everyone in the \"New whiteboard\" picker. Upload a .whiteboard file; new boards created from it start with a copy of its content.",
    "Upload canvas" : "Upload canvas",
    "Loading organization canvases…" : "Loading organization canvases…",
    "No organization canvases yet. Upload a .whiteboard file to share a starting board with everyone." : "No organization canvases yet. Upload a .whiteboard file to share a starting board with everyone.",
    "Delete canvas {name}" : "Delete canvas {name}",
    "Advanced settings" : "Advanced settings",
    "Max image size (MB)" : "Max image size (MB)",
    "Output is generated by AI. Make sure to always double-check." : "Output is generated by AI. Make sure to always double-check.",
    "Diagram shown here is generated by AI. Make sure to always double-check." : "Diagram shown here is generated by AI. Make sure to always double-check.",
    ...
    "Recording preference saved." : "Recording preference saved.",
    "Failed to save recording preference." : "Failed to save recording preference.",
    "Recording" : "Recording",
    "Choose what happens to your recording if you leave a board." : "Choose what happens to your recording if you leave a board.",
    "Save recordings automatically when I leave a board" : "Save recordings automatically when I leave a board",
    "When enabled, the server will save your recording if you close the tab or lose connection." : "When enabled, the server will save your recording if you close the tab or lose connection.",
    ...
    "Could not load the library \"{name}\"." : "Could not load the library \"{name}\".",
    "Enter a library name." : "Enter a library name.",
    "Add at least one shape to your library first." : "Add at least one shape to your library first.",
    "Organization library saved." : "Organization library saved.",
    "Library saved." : "Library saved.",
    "A canvas template with this name already exists. Choose a different name." : "A canvas template with this name already exists. Choose a different name.",
    "Could not save library." : "Could not save library.",
    "Enter a canvas name." : "Enter a canvas name.",
    "This whiteboard has no content to save as a canvas." : "This whiteboard has no content to save as a canvas.",
    "Canvas is too large (max 15 MB)." : "Canvas is too large (max 15 MB).",
    "Organization canvas published." : "Organization canvas published.",
    "Canvas saved to your Templates folder." : "Canvas saved to your Templates folder.",
    "A library with this name already exists. Choose a different name." : "A library with this name already exists. Choose a different name.",
    "Could not save canvas." : "Could not save canvas.",
    "Max image size is {max} MB" : "Max image size is {max} MB",
    "My library" : "My library",
    "Comments" : "Comments",
    "Voting" : "Voting",
    "Save as library" : "Save as library",
    "Save your current library as a reusable, named library. New whiteboards can start from it, and updates reach every board using it." : "Save your current library as a reusable, named library. New whiteboards can start from it, and updates reach every board using it.",
    "Library name" : "Library name",
    "Save as canvas" : "Save as canvas",
    "Save a copy of this whiteboard as a canvas. New whiteboards created from it start with its content." : "Save a copy of this whiteboard as a canvas. New whiteboards created from it start with its content.",
    ...
    "Stopping…" : "Stopping…",
    "Stop" : "Stop",
    "{presenterName} is presenting" : "{presenterName} is presenting",
    ...
    "{presenterName} is currently presenting. Others will follow their viewport." : "{presenterName} is currently presenting. Others will follow their viewport.",
    ...
    "Other user recording" : "Other user recording",
    "Others recording" : "Others recording",
    ...
    "Only me" : "Only me",
    "Everyone in the organization" : "Everyone in the organization",
    "Saving…" : "Saving…",
    ...
    "Select an item on canvas to add it here, or add a local library below." : "Select an item on canvas to add it here, or add a local library below.",
